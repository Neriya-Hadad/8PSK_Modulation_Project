...
% Plot the signals before filtering
figure;
hold on;
stairs(t, [in_phase_signal in_phase_signal(end)], 'r', 'LineWidth', 1.5);
stairs(t, [quadrature_signal quadrature_signal(end)], 'b', 'LineWidth', 1.5);
hold off;
...
figure;
hold on;
stairs(t, [in_phase_filtered in_phase_filtered(end)], 'r', 'LineWidth', 1.5);
stairs(t, [quadrature_filtered quadrature_filtered(end)], 'b', 'LineWidth', 1.5);
hold off;
...
% Plot the constellation before filtering
figure;
...
% Plot the constellation after filtering
figure;
